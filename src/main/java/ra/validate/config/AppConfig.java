...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"ra.validate.controller", "ra.validate.service.imp", "ra.validate.repository.imp", "ra.validate.mapper"})
...
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/User_Management_DB");
...
//        properties.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQL8InnoDBDialect");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ra.validate.model");
